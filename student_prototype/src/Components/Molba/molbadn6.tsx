...
import {getStudent, sendRequest, updateRequest, deleteRequest,} from '../../api/api';
                    ...
                    <Col sm='3' xs='11' style={styles.evenColumn}>
                        { uciliste === "none" ?
                            <select onChange={setUcili} value={uciliste} style={styles.inputIncorrect} >
                                ...
                                <option value="three">Faculty of Dental Medicine</option>
                            </select>
                            :
                    ...
                    <Col sm='3' xs='11' style={styles.evenColumn}>
                        { vrstaStudija === "none" ?
                            <select onChange={setVrstaStud} value={vrstaStudija} style={styles.inputIncorrect} >
                                ...
                                <option value="three">postgraduate university study</option>
                            </select>
                            :
                    ...
                    <Label className='col-sm-4' style={styles.formLabel}>Accommodation category</Label>
                        ...
                        { kategorijaSmjestaja === "none" ?
                                <select onChange={setKategorijaSmje} value={kategorijaSmjestaja} style={styles.inputIncorrect} >
                                    <option value="none">none</option>
                                    <option value="I">I category</option>
                                    <option value="II">II category</option>
                                    <option value="II">III category</option>
                                </select>
                                :
...
async function sendData() {
    ...
    let statusCode;
    if(edited){
        statusCode = await updateRequest(updateStateStudent);
    } 
    else
    {
        statusCode = await sendRequest(updateStateStudent);
    }
...
async function deleteVrstaStud(){
    ...
    let statusCode = await deleteRequest(Id);
...
function resetAllStates() {
    ...
    setKucniBroj('');
    setUciliste('None');
    setVrstaStudija('None');
    setStudij('None');

    setVrstaMolbe('None');
    setKategorijaSmjestaja('None');
    setKategorijaSmjestaja2('None');
