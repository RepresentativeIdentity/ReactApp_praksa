...
import {StudentDto} from './store/model';
...
function Molba() {
    ...
    const [drzavljanstvo, setDrzavljanstvo] = useState('Afghan');
            ...
            <Card>
                ...
                <Row style={{ marginBottom: '2%' }}>
                    ...
                    <Col sm='3' xs='11' style={styles.evenColumn}>
                     {(jmbg.match('^[0-9]+$') === null || jmbg.length !== 13)? 
                        <input onChange={setJmb} value={jmbg} style={styles.inputIncorrect}/> 
                        :
                        <input onChange={setJmb} value={jmbg} style={styles.inputWidth} />
                    }
                    </Col>
                ...
                <Row style={{margin: '3%'}}>
                    ...
                    {   save ?
                        ...
                        :
                        <Button onClick={postVrstaStud} color='primary'>Save</Button>
                    }
                    </Col>
...
function validationChecker(){
    if (!(jmbg.match('^[0-9]+$') === null || jmbg.length !== 13)
